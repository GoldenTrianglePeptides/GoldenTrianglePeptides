...
import { toggleStock, toggleFeatured, updatePrice } from "./actions";
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <p className="mb-4 text-sm text-zinc-500">
        ...
        instantly. Edit the price inline, or use Edit for the full record.
      </p>
                ...
                <td className="p-3">
                  <form action={updatePrice} className="flex items-center gap-1">
                    ...
                    <input
                      ...
                      className="w-20 rounded-md border border-black/15 px-2 py-1 text-sm outline-none focus:border-gold"
                    />
                    <button
                      type="submit"
                      className="rounded-md border border-black/15 px-2 py-1 text-xs font-semibold text-navy hover:border-navy"
                    >
                      Save
                    </button>
                  </form>
